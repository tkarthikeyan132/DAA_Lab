...
int main()
{
    ...
    switch (p)
    {
        ...
        case 1:
        {
            cout << " Enter the algorithm no 1, 2, 3 or 5 for prob1. Algo 4 is at the end of this program: ";
            cin >> p;
            switch(p)
            {
                case 1:{
                ...
                case 3:{
                    ...
                    Mega = union_of_array(List,k);
                    cout<<"Sorted array:";
                    for(int z=0;z<Mega.size;z++)
                        cout<<Mega.M[z]<<" ";
                    break;}
...
//____________________Algo 4 problem 1 done here______________________________
    int S[k];
    node* root = NULL;
    cout << "\nAlgo4 for problem1 starts:" << endl;
